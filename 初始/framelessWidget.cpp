    ...
    , ui(new Ui::framelessWidget)
{
    ...
    connect(ui->checkBox,&QPushButton::clicked,this,&framelessWidget::clickSound);
    //connect(ui->confirm,&QPushButton::clicked,this,&framelessWidget::clickSound);
...
//    ui->mainWidget->setStyleSheet(mainStyle);
    ...
    border->show();
    //搞一个动画
    QMovie *movie = new QMovie(":/picture/gif/1.gif");
